...
| `timeout-settings` | Spring Boot, Apache HttpClient 5, HikariCP, Testcontainers | HTTP timeout, keep-alive, connection TTL, MySQL wait_timeout 과 HikariCP max-lifetime 관계를 재현하는 예제 |
